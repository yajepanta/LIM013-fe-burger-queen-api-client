...
const Home = () => {
  ...
  const sendOrder = () => {
    ...
    const products = orderArray.map((el) => {
      return { productId: el._id, qty: el.qty };
    });
    const body = {
      userId: null,
      client: client,
    ...
    setOrderArray([]);
    handleInput("client", "das");
    handleInput("numberTable", " ");
        ...
        <section className="order-container">
          ...
          <div className="order-products">
            <div
              ...
              onClick={(e) => handleProduct(e.target.id, e.target.className)}
            >
              {orderArray.map((el) => {
            ...
            <Label
              ...
              text={`Total: S/.${totalPrice.reduce((a, b) => {
                return a + b;
              })}`}
            ></Label>
